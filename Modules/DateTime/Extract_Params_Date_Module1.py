# -*- coding: utf-8 -*-
"""
    QB project: Params Date Module_2
    Extract all params date for 'Appointment','CareProvider',...
...
#******************************************************************************
def param_date_module1(f_params_dict,f_text):
    ...
    #---------------------------------------------------------------------
    # final 'params_date_dict': for all params except 'claims'
    #---------------------------------------------------------------------
    params_date_dict={}
    for pad_param in param_padtoken_dict.values():                             # Access padparam one-by-one
        ...
        if param_name not in ['Risk Score','Radiology Visit','Readmission Count',
                              'ER Visit','Inpatient Spend','Hospital outpatient Spend',
                              'Pharmacy Spend','Professional outpatient Spend','SNF Spend',
                              'Home Health Spend','Hospice Spend','DME Spend','Total Spend']:
...
result= param_date_module1(optimize_params[1],optimize_params[0])
print('\nFinal Dic=\n',result)
'''